...
then
    ...
    (cd swc_ecma_ast && rustup run nightly-2021-06-27 cargo rustdoc -- --output-format json -Z unstable-options)
    ...
    (cd swc_ecma_parser && rustup run nightly-2021-06-27 cargo rustdoc -- --output-format json -Z unstable-options)
